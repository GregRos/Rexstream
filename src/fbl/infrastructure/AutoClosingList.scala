...
import fbl.events.{ObservableCollection, BufferChangedNotifier}
import fbl.util._
import scala.collection._
/**
  * Created by GregRos on 13/02/2016.
  */
class AutoClosingList[T](inner : ObservableCollection[T]) extends mutable.Buffer[T] with BufferChangedNotifier[T] {
