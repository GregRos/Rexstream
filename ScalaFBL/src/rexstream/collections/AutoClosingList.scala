...
/**
  ...
  */
private[rexstream] class AutoClosingList[T] (inner : ObservableList[T]) extends mutable.Buffer[T] with ItemChangedNotifier[T] with AutoCloseable {
